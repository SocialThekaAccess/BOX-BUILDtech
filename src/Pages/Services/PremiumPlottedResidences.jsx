...
const F = ({ children, className = '', delay = 0 }) => {
  const ref = useFade();
  return <div ref={ref} className={`pp-f ${className}`} style={{ transitionDelay: `${delay}ms` }}>{children}</div>;
};
      ...
      <section className="pp-split pp-dark">
        ...
        <div className="pp-split-content">
          <F>
            ...
            <h2 className="pp-h2">Premium Plotted Residences for Modern Families</h2>
      ...
      <section className="pp-split pp-navy pp-flip">
        ...
        <div className="pp-split-content">
          <F>
            ...
            <h2 className="pp-h2">Why More Families Are Choosing Plotted Residences</h2>
            <div className="pp-bar" />
            ...
            <p className="pp-body">When you have a plotted residence, you get to decide how your home looks. You can choose the design, the size of the rooms and what the inside and outside of your home looks like — all based on how you live.</p>
            <ul className="pp-list">
      ...
      <section className="pp-split pp-dark">
        ...
        <div className="pp-split-content">
          <F>
            ...
            <h2 className="pp-h2">A Smart Investment for the Future</h2>
            <div className="pp-bar" />
      ...
      <section className="pp-cta-banner">
        ...
        <div className="pp-cta-inner">
          <F>
            ...
            <h2 className="pp-cta-h2">Your Dream Home Deserves the Right Beginning</h2>
